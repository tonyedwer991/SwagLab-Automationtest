...
public class MyListenere implements WebDriverListener {
    @Override
    public boolean throwsExceptions() {
        return WebDriverListener.super.throwsExceptions();
    }
    ...
    public <X> void beforeGetScreenshotAs(WebDriver driver, OutputType<X> target) {
        WebDriverListener.super.beforeGetScreenshotAs(driver, target);
    }

    @Override
    public <X> void afterGetScreenshotAs(WebDriver driver, OutputType<X> target, X result) {
        WebDriverListener.super.afterGetScreenshotAs(driver, target, result);
    }
    ...
    public <X> void beforeGetScreenshotAs(WebElement element, OutputType<X> target) {
        WebDriverListener.super.beforeGetScreenshotAs(element, target);
    }

    @Override
    public <X> void afterGetScreenshotAs(WebElement element, OutputType<X> target, X result) {
        WebDriverListener.super.afterGetScreenshotAs(element, target, result);
    }
    ...
    @Override
    public void beforeScriptTimeout(WebDriver.Timeouts timeouts, Duration duration) {
        WebDriverListener.super.beforeScriptTimeout(timeouts, duration);
    }

    @Override
    public void afterScriptTimeout(WebDriver.Timeouts timeouts, Duration duration) {
        WebDriverListener.super.afterScriptTimeout(timeouts, duration);
    }
